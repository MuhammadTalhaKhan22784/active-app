...
//components-data
import weeklyExercises from '../../assets/componentsData/weeklyExercisesDisabled'
import recommendations from '../../assets/componentsData/doctorReccomendation'
import tasks from '../../assets/componentsData/weeklyTasksDisabled'
...
import progressLogo from '../../assets/svgs/noProgressIcon.svg'
import doctorLogo from '../../assets/svgs/disabledDoctorIcon.svg'
import messagesLogo from '../../assets/svgs/disabledMessagesIcon.svg'
import uploadFilesLogo from '../../assets/svgs/uploadFiles.svg'

//css
import stylesSheet from './papt.module.css'
        ...
        return (
          <>
            <div
              className={
                task.isDisabled
                  ? `${stylesSheet.task} ${stylesSheet.disabledComponent} ${stylesSheet.backgroundWhite}`
                  : `${stylesSheet.task} ${stylesSheet.backgroundWhite}`
              }
            >
              <div
                className={
                  task.isCompleted
                    ? `${stylesSheet.completedTaskTitle} ${stylesSheet.taskName} ${stylesSheet.title}`
                    : task.isFailed
                    ? `${stylesSheet.failedTaskTitle} ${stylesSheet.taskName} ${stylesSheet.title}`
                    : `${stylesSheet.backgroundBlue} ${stylesSheet.taskName} ${stylesSheet.title}`
                }
              >
                {task.taskName}
              ...
              <div className={`${stylesSheet.taskDesc} ${stylesSheet.desc}`}>
                {task.taskDesc}
              </div>
              ...
              >
                <button
                  className={task.isCompleted ? stylesSheet.gradient : ''}
                >
                  התחל עכשיו
                </button>
              </div>
...
const FirstRow = () => {
  ...
  return (
    <div className={stylesSheet.firstRow}>
      ...
      <div
        className={`${stylesSheet.onlineConsultaion} ${stylesSheet.backgroundWhite} ${stylesSheet.disabledComponent}`}
      >
...
const SecondRow = () => {
  return (
    <div className={stylesSheet.secondRow}>
      ...
      <div
        className={`${stylesSheet.aa} ${stylesSheet.backgroundWhite} ${stylesSheet.disabledComponent}`}
      >
        <div
    ...
    <>
      ...
      <div className={`${stylesSheet.fourthRow} ${stylesSheet.messages}`}>
        ...
        >
          ...
          <div className={`${stylesSheet.contactDesc} ${stylesSheet.desc}`}>
        ...
        >
          ...
          <div className={`${stylesSheet.desc} ${stylesSheet.messagesDesc}`}>
