...
//css
import stylesSheet from './wperror.module.css'
    ...
    >
      <Modal.Header id='contained-modal-title-vcenter'>
        <div className='modalHeader'>
          <div className='errorModalHeader'>
            <div>
              <ExclaimationIconForError />
              <h2 className='warning'>הזהרה!</h2>
            </div>
            <div className=''>
              <a href=''>הזהרה!</a>
            </div>
      ...
      <Modal.Body>
        <div className='errorModalBody'>
          ...
          <br />
          <p>
            <strong>, נא לשבת עוד מספר דקות ולבצע בדיקה נוספת</strong>
            דופק המנוחה גבוה מהרצוי.
          </p>
          <p>
          ...
          <p>
            <strong>, נא לשבת עוד מספר דקות ולבצע בדיקה</strong>
            הסיטורציה במנוחה נמוכה מהרצוי נוספת.
          </p>
          <p>
      ...
      <Modal.Footer>
        <div className='errorModalFooter'>
          <div className='errorModalFooterInputs'>
            <div className='errorModalAnswer'>
              <p className='modalQuestion'>satO2%</p>
              <input type='text' placeholder='הכנס נתון' />
            </div>
            <div className='errorModalAnswer'>
              <p className='modalQuestion'>דופק HR</p>
              <input type='text' placeholder='הכנס נתון' />
            </div>
          </div>
          <div>
...
const Main = () => {
  const [errorModalShow, setErrorModalShow] = React.useState(true)
